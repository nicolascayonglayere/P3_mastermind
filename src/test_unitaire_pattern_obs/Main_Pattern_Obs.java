...
import ihm.Accueil;
import test_unitaire_table_jeu.TableDeJeuMasterMind_ModeChall;
import test_unitaire_table_jeu.TableDeJeuMasterMind_ModeDef;
import test_unitaire_table_jeu.TableDeJeuPlusMoins_ModeChall;
import test_unitaire_table_jeu.TableDeJeuPlusMoins_ModeDef;
import test_unitaire_table_jeu.TableDeJeuPlusMoins_ModeDuel;
import test_unitaire_table_jeu.TableDeJeu_Test;


public class Main_Pattern_Obs extends JFrame {
	
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(Main_Pattern_Obs.class);
	...
	public static void main(String[] args) {
		Main_Pattern_Obs f = new Main_Pattern_Obs();
		f.setVisible(true);

...
public class TableDeJeu_Pattern_Obs_1 extends TableDeJeu_Pattern_Obs{
	...
	public TableDeJeu_Pattern_Obs_1() {
		super();
	}
	
	public TableDeJeu_Pattern_Obs_1(String pJeu, String pMode, int pEssai, int pCombo, int pCouleur) {
